...
object RunnableApp extends JFXApp {
  private val log = LoggerFactory.getLogger("com.mazhangjing.lhl.RunnableApp")
          ...
          new Button("实验1") {
            onAction = _ => {
              if (check("main.activateExp1")) new ExpStarter {}
                .runExperiment("com.mazhangjing.lhl.LHLExperiment1", fullScreen = !ExpConfig.IS_DEBUG, mainStage)
            }
          },
          new Button("实验2") {
            onAction = _ => {
              if (check("main.activateExp2")) new ExpStarter {}
                .runExperiment("com.mazhangjing.lhl.LHLExperiment2", fullScreen = !ExpConfig.IS_DEBUG, mainStage)
            }
          },
          new Button("实验3 JMMJ") {
            onAction = _ => {
              ...
              if (check("main.activateExp3_1")) new ExpStarter {}
                .runExperiment("com.mazhangjing.lhl.LHLExperiment3", fullScreen = !ExpConfig.IS_DEBUG, mainStage)
            }
          },
          new Button("实验3 MJJM") {
            onAction = _ => {
